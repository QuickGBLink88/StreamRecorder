================================================================================
    MICROSOFT 基础类库： StreamRecord 项目概述
===============================================================================

应用程序向导已为您创建了此 StreamRecord 应用程序。此应用程序
不仅介绍了使用 Microsoft 基础类的基本知识，
而且是编写应用程序的起点。

此文件包含组成 StreamRecord 应用程序的每个文件的内容摘要。
...
res\StreamRecord.ico
    这是一个图标文件，用作应用程序的图标。  此
    图标包含在主资源文件 StreamRecord.rc 中。

res\StreamRecord.rc2
    此文件包含不由 Microsoft 
...
StdAfx.h、StdAfx.cpp
    这些文件用于生成名为 StreamRecord.pch 的预编译头文件 (PCH)
